...
namespace Project
{
    public partial class Cahier_Management : Form
    {
        ...
        public void autoID()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SELECT id FROM cashier ORDER BY id DESC limit 1", con);
        ...
        {
            MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM cashier ", con);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (txtid.Text != "" && txtfname.Text != "" && txtlname.Text != "" && txtnic.Text != "" && txtgender.Text != "" && txtpass.Text != "" && txtphone.Text != "" && txtuser.Text != "" && txtaddress.Text != "")
            {
                MySqlCommand cmd = new MySqlCommand("INSERT INTO cashier VALUES ('" + txtid.Text + "','" + txtfname.Text + "','" + txtlname.Text + "','" + txtphone.Text + "','" + txtnic.Text + "','" + txtgender.Text + "','" + txtaddress.Text + "')", con);
                MySqlCommand cmd1 = new MySqlCommand("INSERT INTO login VALUES ('" + txtuser.Text + "','" + txtpass.Text + "','" + admin + "')", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("NIC is already added", "Cashier is already added", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter sda = new MySqlDataAdapter("SELECT COUNT(*) FROM cashier WHERE id='" + txtsearchbyid.Text + "' or nic='" + txtsearchbyid.Text + "' ", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows[0][0].ToString() == "1")
            {
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM cashier WHERE id='" + txtsearchbyid.Text + "' or nic='" + txtsearchbyid.Text + "'  ", con);
                con.Open();
                ...
                {
                    MySqlCommand cmd2 = new MySqlCommand("SELECT * FROM cashier WHERE nic='" + txtsearchbyid.Text + "'", con);
                    con.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlCommand cmd = new MySqlCommand("UPDATE cashier SET fname='" + txtfnameup.Text + "',lname= '" + txtlnameup.Text + "',address= '" + txtaddressup.Text + "', phone= '" + txtphoneup.Text + "' ,nic='" + txtnicup.Text + "' , gender='" + txtgenderup.Text + "' WHERE id LIKE '" + txtsearchbyid.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        {
            key = txtnicup.Text;
            MySqlDataAdapter sda = new MySqlDataAdapter("SELECT COUNT(*) FROM cashier WHERE nic='" + txtnicup.Text + "' ", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows[0][0].ToString() != "1")
            {
